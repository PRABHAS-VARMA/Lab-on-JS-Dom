...
var x = document.getElementsByClassName('dom-methods');
...
var y = document.querySelectorAll('.dom-methods');
...
z.appendChild(b);
b.innerText = 'This is a paragraph tag';
...
z.classList.remove('footer');
z.classList.add('dom-method-footer');
